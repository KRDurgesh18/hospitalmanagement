...
public class PatientserviceImp implements Patientservice {
	...
	public Patientresponse updatePatient(String uid,Patientrequest request)
	{
		Patient patient=patientrepository.findByUid(uid).orElseThrow(()->new RuntimeException("Patient not found with id : "+uid));
